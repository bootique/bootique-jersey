...
public class JerseyClientModuleProvider_MetadataIT {
    ...
    public void testMetadata() {
        ...
        assertEquals("jerseyclient" +
                ...
                "[map:auth<java.lang.String,io.bootique.jersey.v3.client.auth.AuthenticatorFactory>]" +
                "[compression:boolean]" +
                "[connectTimeoutMs:int]" +
                "[followRedirects:boolean]" +
                "[readTimeoutMs:int]" +
                "[map:targets<java.lang.String,io.bootique.jersey.v3.client.WebTargetFactory>]" +
                "[map:trustStores<java.lang.String,io.bootique.jersey.v3.client.TrustStoreFactory>]", result);
    }
}
