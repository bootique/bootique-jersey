...
@BQTest
public class WireMockRecordingTester_WithPathIT extends TestWithEmulatedBackend {

    @BQTestTool
    static final WireMockRecordingTester tester = WireMockTester.recordingTester(SERVER_URL + "/p1");
